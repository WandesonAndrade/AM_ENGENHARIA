...
export default function BudgetCalculator() {
  ...
  const [projectType, setProjectType] =
    useState<ProjectCategory>("residencial");
  ...
  const handleFormSubmit = (e: FormEvent) => {
    ...
    const typesMap: Record<ProjectCategory, string> = {
      ...
      instalacoes: "Instalações de Gás",
      tecnologia: "Tecnologia & Segurança",
      eletrica: "Instalações Elétricas",
      hidrossanitario: "Instalações Hidrossanitárias",
      seguranca: "Prevenção & Combate a Incêndio",
    };
    ...
    try {
      ...
      setValidationError(
        "Ocorreu um erro ao abrir o WhatsApp. Por favor, tente novamente.",
      );
    }
  };
  ...
  return (
    <section
      id="orcamento"
      className="py-24 bg-[#0d0e0e] border-y border-[#1f2020] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-sans text-4xl md:text-5xl font-black uppercase text-white tracking-tight leading-none">
            SOLICITAR{" "}
            <span className="text-brand-cyan">ORÇAMENTO PERSONALIZADO</span>
          </h2>
          <p className="font-sans text-xs md:text-sm text-gray-400 font-light">
            Descreva suas ideias e parâmetros preliminares. Nossa equipe de
            engenharia civil sênior gerará um estudo de viabilidade completo
            compatível com o seu terreno ou planta.
          </p>
        </div>
        ...
        {isSubmitted ? (
          ...
          <div className="max-w-2xl mx-auto bg-[#1b1c1c]/45 border border-brand-cyan/30 p-8 md:p-12 text-center space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-2">
              <span className="font-mono text-[9px] text-[#b7d2db] uppercase tracking-widest block">
                SOLICITAÇÃO ENVIADA COM SUCESSO
              </span>
              <h3 className="font-sans text-2xl md:text-3xl font-black text-white uppercase tracking-tight">
                Estudo Enviado ao WhatsApp
              </h3>
            </div>

            <p className="font-sans text-sm text-gray-300 max-w-md mx-auto leading-relaxed font-light">
              Prezado(a) <strong className="text-white">{clientName}</strong>,
              sua solicitação foi formatada e aberta no seu WhatsApp. Um
              engenheiro civil sênior fará uma análise inicial da sua planta ou
              projeto em até 24 horas úteis.
            </p>

            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 justify-center pt-6 max-w-sm mx-auto">
              <button
                onClick={resetForm}
                className="w-full bg-brand-cyan hover:bg-[#59b2b8] text-black font-mono text-xs font-bold uppercase tracking-wider py-4 select-none transition-all flex items-center justify-center space-x-2 cursor-pointer rounded-none"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <form
              ...
              className="lg:col-span-7 bg-[#1b1c1c]/45 border border-[#343535] p-6 md:p-8 space-y-6 relative"
            >
              ...
              {validationError && (
                <div className="bg-red-950/20 border border-red-500/50 p-4 text-red-400 text-xs font-sans leading-relaxed flex items-start space-x-2">
                  <span className="font-bold font-mono text-red-500 shrink-0 uppercase">
                    [ERRO]:
                  </span>
                  <p>{validationError}</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    value={projectType}
                    onChange={(e) =>
                      setProjectType(e.target.value as ProjectCategory)
                    }
                  ...
                  >
                    <option value="residencial">
                      Projeto Residencial Sob Medida
                    </option>
                    <option value="comercial">
                      Comércio / Lojas / Clínicas
                    </option>
                    <option value="corporativo">
                      Escritórios / Corporativo
                    </option>
                    <option value="reformas">
                      Reformas Estruturais / Retrofit
                    </option>
                  </select>
                </div>
              ...
              <button
                type="submit"
                className="w-full bg-brand-cyan hover:bg-[#59b2b8] text-black font-mono text-xs font-bold uppercase tracking-wider py-4 select-none transition-all flex items-center justify-center space-x-2 shadow-lg cursor-pointer rounded-none mt-6"
              >
            ...
            <div className="lg:col-span-5 flex flex-col space-y-6">
              ...
              <div className="bg-[#121414] border border-brand-cyan/30 p-6 md:p-8 relative overflow-hidden">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h5 className="font-sans font-bold text-xs text-white uppercase tracking-tight">
                        Estudo de Clima Territorial
                      </h5>
                      <p className="font-sans text-[11px] text-gray-400 mt-1 leading-relaxed font-light">
                        Mapeamos dados geológicos e restrições municipais da
                        localidade do seu projeto para mitigar atrasos de
                        aprovação.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="font-sans text-[11px] text-gray-400 mt-1 leading-relaxed font-light">
                        Modelamos sua necessidade de espaço em maquete
                        paramétrica piloto, identificando gargalos construtivos
                        precocemente.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="font-sans text-[11px] text-gray-400 mt-1 leading-relaxed font-light">
                        Esboçamos estimativas de insumos reais com base na
                        tabela Sinapi atualizada, blindando seu planejamento
                        financeiro.
                      </p>
                    </div>
                  </div>
                ...
                <div className="border-t border-[#1f2020] mt-8 pt-6">
                  <div className="flex items-center space-x-2.5 text-xs text-gray-400">
                    ...
                    <span className="font-light">
                      Canaís criptografados diretos com nossos diretores
                      técnicos.
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-[#1b1c1c]/25 border border-[#1f2020] p-6 text-center space-y-2">
                <span className="font-mono text-[9px] text-[#b7d2db] tracking-wider uppercase">
                  SUPORTE ESTRUTURAL REGISTRADO
                </span>
                <p className="font-sans text-[11px] text-gray-500 leading-relaxed font-light">
                  Possui plantas DWG ou PDF? Envie-as diretamente pelo chat de
                  atendimento do WhatsApp após selecionar seu consultor técnico
                  sênior responsável.
                </p>
              </div>
            </div>
