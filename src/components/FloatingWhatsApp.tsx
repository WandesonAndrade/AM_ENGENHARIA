...
export default function FloatingWhatsApp() {
  ...
  const whatsappLink =
    "https://wa.me/5599984400511?text=Olá! Gostaria de fazer um orçamento técnico para o meu projeto com a AM Engenharia.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[90] flex flex-col items-end pointer-events-none">
        ...
        <div className="pointer-events-auto bg-[#1b1c1c] border border-brand-cyan/30 text-white p-3.5 shadow-[0_4px_25px_rgba(34,197,94,0.15)] mb-3 max-w-[260px] animate-fade-in relative">
          ...
          <div className="space-y-1.5 text-left">
            ...
            <p className="font-sans text-[11px] text-gray-300 font-light leading-relaxed leading-snug">
              Engenheiro disponível para guiar seu projeto de construção,
              reforma ou cálculo em BIM.
            </p>
            <a
              href={whatsappLink}
              target="_blank"
      ...
      >
        ...
        >
          <path
            d="M12.012,2.004C6.502,2.004,2.01,6.493,2.01,12.002c0,1.912,0.542,3.751,1.564,5.34L2.03,22l4.823-1.493
