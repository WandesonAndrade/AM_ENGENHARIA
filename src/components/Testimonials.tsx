...
export default function Testimonials() {
  return (
    <section id="depoimentos" className="py-24 bg-[#121414] relative overflow-hidden border-b border-[#1f2020]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <p className="font-sans text-xs md:text-sm text-gray-400 font-light">
            A opinião de quem confiou suas fundações, lajes e orçamentos à nossa governança técnica de engenharia. Transparência construída dia após dia.
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-1.5">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 text-brand-cyan fill-current" />
                  ))}
                </div>
              ...
              <div className="flex items-center space-x-4 pt-6 border-t border-[#1f2020] mt-8">
                ...
                <img
                  src={t.avatar}
                  alt={t.name}
                  className="w-12 h-12 rounded-none border border-[#343535] group-hover:border-brand-cyan/70 transition-colors object-cover select-none"
                />
                
                <div className="space-y-0.5">
                  <h4 className="font-sans font-bold text-sm text-white">{t.name}</h4>
                  ...
                  <div className="flex items-center space-x-1 font-mono text-[9px] text-brand-cyan uppercase mt-1">
                    ...
                    <span className="truncate max-w-[150px]">{t.projectAssoc}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 pt-12 border-t border-[#1f2020] grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-4xl mx-auto">
          <div>
            <div className="font-sans font-extrabold text-brand-cyan text-sm uppercase">CREA CERTIFICADO</div>
            <p className="font-sans text-[10px] text-gray-500 mt-1 font-light">Anotações de Responsabilidade Técnica (ART) registradas em todos os layouts.</p>
          </div>
          <div>
            <div className="font-sans font-extrabold text-brand-cyan text-sm uppercase">ENTREGA SEGURA</div>
            <p className="font-sans text-[10px] text-gray-500 mt-1 font-light">Seguro completo contra avarias estruturais civis e responsabilidade a terceiros.</p>
          </div>
          <div>
            <div className="font-sans font-extrabold text-brand-cyan text-sm uppercase">AVALIAÇÃO 5.0</div>
            <p className="font-sans text-[10px] text-gray-500 mt-1 font-light text-center">Classificação máxima unânime em Google Negócios e auditorias independentes.</p>
          </div>
          <div>
            <div className="font-sans font-extrabold text-brand-cyan text-sm uppercase">SISTEMA BIM</div>
            <p className="font-sans text-[10px] text-gray-500 mt-1 font-light text-center">Compatibilização 3D de fiação estrutural e tubos com tolerância zero de erro.</p>
          </div>
        </div>
